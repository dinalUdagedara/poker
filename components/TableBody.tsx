 ...
 * felt). The wide one is the Salon render — `render-table-desktop.py --skin
 * salon` — which prints its own racing green and champagne line. Seats, cards and chips stay 2D on top — that is the same split their
